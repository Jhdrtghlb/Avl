...
$API_KEY = '7277284824:AAFsHqant9-DGBqtIHUeOpMAXnwxNJ4shDM';
...
'reply_to_message_id'=>$mid,
    'reply_markup'=>json_encode([
      'inline_keyboard'=>[
        [['text'=>"اضفــني لكــروبك🔴 ⌚️",'url'=>"t.me/test118bot?startgroup=new"]],
        [['text'=>"قناة المطور🔴", 'url'=>"t.me/M1_m2s"]]
    ]
...
'reply_markup'=>json_encode([
      'inline_keyboard'=>[
        [
          ['text'=>'المطور💚', 'url'=>"https://t.me/t7tt1"]
        ],
        ]
        ])
]);
